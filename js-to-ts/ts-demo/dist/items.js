        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    html_code = "";
                    return [4 /*yield*/, fetch("https://xivapi.com/item/".concat(searchItem))];
                case 1:
                    response = _a.sent();
                ...
                case 2:
                    item = _a.sent();
                    console.log(item);
                    html_code += "<h1>".concat(item.Name, "</h1>");
                    html_code += "<img src=\"https://xivapi.com/".concat(item.IconHD, "\"/>");
